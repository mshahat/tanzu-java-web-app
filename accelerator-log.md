...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=mshahat&repo=tanzu-java-web-app",
  "projectName" : "tanzu-java-web-app",
  "repositoryPrefix" : "eu.gcr.io/pa-mshahat"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [your-registry.io/project->eu.gcr.io/pa-mshahat]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=mshahat&repo=tanzu-java-web-app'
